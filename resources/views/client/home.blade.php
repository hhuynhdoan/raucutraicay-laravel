...
@section('content')
    ...
    <section id="home-section" class="hero">
		  <div class="home-slider owl-carousel">
			...
			<div class="slider-item" style="background-image: url({{asset('/storage/anh_sl/'.$slider->anh_sl)}});">
				<div class="overlay"></div>
				<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

					<div class="col-md-12 ftco-animate text-center">
					<h1 class="mb-2">{{$slider->mota1}}</h1>
					<h2 class="subheading mb-4">{{$slider->mota2}}</h2>
    	...
    	<div class="container">
    		<div class="row">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
              {{-- {{asset('/productsingle/'.$prod->id)}} --}}
    					<a href="client/product_single/{{$prod->id}}" class="img-prod"><img class="img-fluid" src="{{asset('/storage/anh_sp/'.$prod->anh_sp)}}" alt="Colorlib Template">
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">{{$prod->ten_sp}}</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"></span>
									<span class="price-sale">{{$prod->gia_sp}}.000 VND </span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="{{asset('/addtocart/'.$prod->id)}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
